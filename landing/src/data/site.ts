...
export const navigation = [
  { label: "Собеседования", href: "/promo/interview-assistant" },
  { label: "IT вакансии", href: "/promo/it-jobs" },
...
export const hero: HeroContent = {
  ...
  description:
    "offerGO — помощник для IT собеседования, подготовки к техническому интервью, поиска работы в IT, React, Flutter и Backend вакансий. В одном сервисе: резюме, отклики, банк вопросов и Windows-помощник.",
  microcopy: "Резюме • IT вакансии • AI-помощник для собеседований • React, Flutter, Backend",
...
export const faq = [
  ...
  {
    question: "Подходит ли помощник для React-разработчиков?",
    answer:
      "Да. Можно готовиться к вопросам по React, TypeScript, Next.js, производительности, компонентам и формировать отклики под frontend вакансии.",
  },
  {
    question: "Подходит ли помощник для Flutter и backend?",
    answer:
      "Да. В promo-хабе есть отдельные разделы под Flutter/Dart и backend: вакансии, вопросы, резюме и подготовка к интервью.",
  },
  {
