...
export const navigation = [
  { label: "Ассистент", href: "/promo" },
  { label: "Резюме", href: "/promo/resume-it" },
...
export const hero: HeroContent = {
  badge: "AI-помощник для IT-собеседований",
  titleMain: "Подготовься к IT-собеседованию",
  titleAccent: "и найди работу быстрее",
  description:
    "offerGO — помощник для IT собеседования, подготовки к техническому интервью и поиска работы в IT: разработка, QA, DevOps, Data/ML, аналитика, продукт, дизайн и смежные роли.",
  microcopy: "Резюме • IT вакансии • AI-помощник для собеседований • Разработка, QA, DevOps, Data, Product",
  ...
  modules: [
    {
      icon: "🌐",
      label: "Web App",
      title: "Резюме, вакансии и отклики",
      detail: "Проверка резюме, индивидуальные сопроводительные письма, автоотклики и поиск IT вакансий.",
    },
    {
      icon: "🖥",
      label: "Windows / macOS",
      title: "Live-подсказки на собеседовании",
      detail: "Помощник для технического интервью, анализа скриншотов и быстрых ответов во время звонка.",
    },
    {
      icon: "📱",
      label: "Android / iOS",
      title: "Нативная подготовка с телефона",
      detail: "Банк вопросов, профиль, тарифы и подготовка к собеседованиям без web-cookie flow.",
    },
    {
      icon: "⚡",
      label: "Free demo",
      title: "Путь от резюме до оффера",
      detail: "Проверка резюме, вакансии, отклики и подготовка к собеседованиям связаны в один сценарий.",
    },
  ],
};
...
export const faq = [
  {
    question: "Как подготовиться к IT-собеседованию?",
    answer:
      "Начните с требований вакансии, повторите ключевые темы по стеку, потренируйте ответы на частые вопросы и заранее подготовьте примеры из опыта.",
  },
  {
    question: "Что спрашивают на техническом интервью?",
    answer:
      "Обычно проверяют стек вакансии, опыт в проектах, архитектурные решения, базы данных, API, алгоритмы, лайвкодинг и умение объяснять trade-off.",
  },
  {
    question: "Как найти работу junior разработчиком?",
    answer:
      "Нужны понятное резюме, демонстрационные проекты, регулярные отклики на junior вакансии и тренировка ответов на базовые технические вопросы.",
  },
  {
    question: "Подходит ли помощник для разных IT-ролей?",
    answer:
      "Да. Можно готовиться к вопросам и откликам для frontend, backend, mobile, QA, DevOps, Data/ML, аналитики, продукта, UX/UI и смежных цифровых специальностей.",
  },
  {
    question: "Подходит ли помощник для смежных цифровых специальностей?",
    answer:
      "Да. offerGO полезен не только разработчикам: аналитикам, project/product менеджерам, UX/UI-дизайнерам, тестировщикам и специалистам поддержки тоже нужны резюме, отклики и подготовка к интервью.",
  },
  {
    question: "Можно ли тренироваться перед реальным собеседованием?",
    answer:
      "Да. Банк вопросов, AI-ответы и Windows-помощник помогают провести mock interview и заранее увидеть слабые места.",
  },
];
