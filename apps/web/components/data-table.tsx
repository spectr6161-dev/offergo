...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    header: "Проверяет",
    cell: ({ row }) => {
      const isAssigned = row.original.reviewer !== "Назначить"
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            <SelectGroup>
              <SelectItem value="outline">Сценарии</SelectItem>
              <SelectItem value="past-performance">Прошлые проверки</SelectItem>
              <SelectItem value="key-personnel">Пользователи</SelectItem>
              <SelectItem value="focus-documents">Документы</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
        <TabsList className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">Сценарии</TabsTrigger>
          <TabsTrigger value="past-performance">
            Прошлые проверки <Badge variant="secondary">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="key-personnel">
            Пользователи <Badge variant="secondary">2</Badge>
          </TabsTrigger>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm">
            <PlusIcon
            />
            <span className="hidden lg:inline">Добавить сценарий</span>
          </Button>
        </div>
      </div>
      <TabsContent
    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>
            Тестовая карточка сценария для проверки интерфейса.
          </DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  Активность выросла на 5.2% за месяц{" "}
                  <TrendingUpIcon className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  Здесь можно быстро проверить drawer, формы и toast-уведомления
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                ...
                <Select defaultValue={item.type}>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectItem value="Auth flow">
                        Auth flow
                      </SelectItem>
                      <SelectItem value="OAuth">
                        OAuth
                      </SelectItem>
                      <SelectItem value="Protected page">
                        Protected page
                      </SelectItem>
            ...
            <div className="flex flex-col gap-3">
              <Label htmlFor="reviewer">Проверяет</Label>
